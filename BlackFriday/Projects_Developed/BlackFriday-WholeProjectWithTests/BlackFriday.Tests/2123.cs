...
public class Tests_2123
{
    // MUST exist within project, otherwise a Compile Time Error will be thrown.
    private static readonly Assembly ProjectAssembly = typeof(StartUp).Assembly;

    [Test]
    public void Validate_RefreshSalesList_UserHasNoDataAccess()
    {
        ...
        var methodArgs3 = new object[] { "CliffRock" };
        var actualResult = InvokeMethod(controller, "RefreshSalesList", methodArgs3);
