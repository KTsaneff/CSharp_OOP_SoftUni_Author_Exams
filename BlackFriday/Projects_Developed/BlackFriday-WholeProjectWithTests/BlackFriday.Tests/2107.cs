...
public class Tests_2107
{
    ...
    public void Validate_RegisterUser_EmailAlreadyUserByAnotherUser()
    {
        ...
        var methodArgs1 = new object[] { "TimBurton", "tim_bbb@email.com", false };
        InvokeMethod(controller, "RegisterUser", methodArgs1);

        var methodArgs2 = new object[] { "TimBurton", "tim_bb@email.com", false };
        var actualResult = InvokeMethod(controller, "RegisterUser", methodArgs2);

        var expectedresult = $"TimBurton is already registered.";
