...
public class Tests_1109
{
    ...
    [Test]
    public void ValidateApplicationProperties()
    {
        var type3 = GetType("Application");

        var type3properties = new[]
        {
            new Property(typeof(IRepository<IProduct>), "Products", "Private"),
            new Property(typeof(IRepository<IUser>), "Users", "Private"),
        };

        ValidateProperties(type3, type3properties);
    }
