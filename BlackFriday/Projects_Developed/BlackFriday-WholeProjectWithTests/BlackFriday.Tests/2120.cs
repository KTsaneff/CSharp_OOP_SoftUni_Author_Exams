...
public class Tests_2120
{
    // MUST exist within project, otherwise a Compile Time Error will be thrown.
    private static readonly Assembly ProjectAssembly = typeof(StartUp).Assembly;

    [Test]
    public void Validate_UpdateProductPrice_ProductDoesNotExist()
    {
        ...
        var methodArgs6 = new object[] { "Keyboard", "TimBurton", 115.00 };
        var actualResult = InvokeMethod(controller, "UpdateProductPrice", methodArgs6);

        var expectedresult = $"Keyboard does not exist in the application.";
