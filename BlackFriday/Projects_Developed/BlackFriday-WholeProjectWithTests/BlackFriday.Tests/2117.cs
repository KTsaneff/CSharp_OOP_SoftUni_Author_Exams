...
public class Tests_2117
{
    // MUST exist within project, otherwise a Compile Time Error will be thrown.
    private static readonly Assembly ProjectAssembly = typeof(StartUp).Assembly;

    [Test]
    public void Validate_PurchaseProduct_ProductPurchasedSuccessfully_DiscountedPrice_ForItem()
    {
        ...
        var methodArgs4 = new object[] { "CliffRock", "SSD", true };
        var actualResult = InvokeMethod(controller, "PurchaseProduct", methodArgs4);

        var expectedresult = $"CliffRock purchased SSD. Price: 231.00";
