...
[TestFixture]
public class Tests_1113
{
    // MUST exist within project, otherwise a Compile Time Error will be thrown.
    private static readonly Assembly ProjectAssembly = typeof(StartUp).Assembly;

    [Test]
    public void ValidateUserRepositoryMethods()
    {
        var type = GetType("UserRepository");

        var methods = new[]
        {
            new Method(typeof(void), "AddNew", typeof(IUser)),
            new Method(typeof(IUser), "GetByName", typeof(string)),
