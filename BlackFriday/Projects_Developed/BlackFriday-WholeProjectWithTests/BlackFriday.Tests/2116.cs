...
public class Tests_2116
{
    // MUST exist within project, otherwise a Compile Time Error will be thrown.
    private static readonly Assembly ProjectAssembly = typeof(StartUp).Assembly;

    [Test]
    public void Validate_PurchaseProduct_ProductPurchasedSuccessfully_NotDiscountedPrice()
    {
        ...
        var methodArgs4 = new object[] { "CliffRock", "SSD", false };
        var actualResult = InvokeMethod(controller, "PurchaseProduct", methodArgs4);

        var expectedresult = $"CliffRock purchased SSD. Price: 330.00";
