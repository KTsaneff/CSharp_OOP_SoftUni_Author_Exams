...
public class Tests_1107
{
    ...
    [Test]
    public void ValidateClientAdditionalProperties()
    {
        var type = GetType("Client");

        var properties = new[]
        {
            new Property(typeof(IReadOnlyDictionary<string,bool>), "Purchases", "Private")
        };
