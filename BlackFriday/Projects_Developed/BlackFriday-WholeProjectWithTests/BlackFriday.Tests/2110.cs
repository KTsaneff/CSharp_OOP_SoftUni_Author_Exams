...
public class Tests_2110
{
    // MUST exist within project, otherwise a Compile Time Error will be thrown.
    private static readonly Assembly ProjectAssembly = typeof(StartUp).Assembly;

    [Test]
    public void Validate_AddProduct_ProductAlreadyExists()
    {
        ...
        var methodArgs2 = new object[] { "Service", "SSD", "TimBurton", 125.00 };
        var methodArgs3 = new object[] { "Item", "SSD", "TimBurton", 330.00 };
        InvokeMethod(controller, "AddProduct", methodArgs2);
        var actualResult = InvokeMethod(controller, "AddProduct", methodArgs3);

        var expectedresult = $"SSD already exists in the application.";
