...
public class Tests_207
{
    // MUST exist within project, otherwise a Compile Time Error will be thrown.
    private static readonly Assembly ProjectAssembly = typeof(StartUp).Assembly;

    [Test]
    public void Validate_SignManager_TeamSignedSuccessfully()
    {
        ...
        var methodArgs2 = new object[] { "Liverpool", "AmateurManager", "NewManager Signed" };

        var actualResult = InvokeMethod(controller, "SignManager", methodArgs2);
        var expectedResult = "Manager NewManager Signed is assigned to team Liverpool.";
