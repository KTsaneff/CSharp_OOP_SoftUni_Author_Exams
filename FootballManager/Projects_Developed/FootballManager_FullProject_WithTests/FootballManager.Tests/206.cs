...
public class Tests_206
{
    // MUST exist within project, otherwise a Compile Time Error will be thrown.
    private static readonly Assembly ProjectAssembly = typeof(StartUp).Assembly;

    [Test]
    public void Validate_SignManager_ManagerTypeIsInvalid()
    {
        ...
        var methodArgs2 = new object[] { "Liverpool", "AmatiorManager", "NewManager Name" };

        var actualResult = InvokeMethod(controller, "SignManager", methodArgs2);
        var expectedResult = "AmatiorManager is an invalid manager type for the application.";
