...
[TestFixture]
public class Tests_107
{
    // MUST exist within project, otherwise a Compile Time Error will be thrown.
    private static readonly Assembly ProjectAssembly = typeof(StartUp).Assembly;

    [Test]
    public void ValidateTeamRepositoryProperties()
    {
        var type1 = GetType("TeamRepository");

        var properties1 = new[]
        {
            new Property(typeof(IReadOnlyCollection<ITeam>), "Models", "Private"),
            new Property(typeof(int), "Capacity", "Private")
        };

        ValidateProperties(type1, properties1);
    }
