...
public class Tests_205
{
    // MUST exist within project, otherwise a Compile Time Error will be thrown.
    private static readonly Assembly ProjectAssembly = typeof(StartUp).Assembly;

    [Test]
    public void Validate_SignManager_TeamNameNotPresented()
    {
        ...
        var methodArgs2 = new object[] { "Brentford", "AmateurManager", "NewManager Name" };

        var actualResult = InvokeMethod(controller, "SignManager", methodArgs2);
        var expectedResult = "Team Brentford does not take part in the Championship.";
