...
public class Tests_203
{
    // MUST exist within project, otherwise a Compile Time Error will be thrown.
    private static readonly Assembly ProjectAssembly = typeof(StartUp).Assembly;

    [Test]
    public void ValidateJoinChampionship_SameNamaAlreadyExists()
    {
        ...
        var actualResult = InvokeMethod(controller, "JoinChampionship", methodArgs);
        var expectedResult = "Liverpool has already joined the Championship.";
