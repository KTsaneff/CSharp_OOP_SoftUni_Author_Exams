...
public class Tests_212
{
    // MUST exist within project, otherwise a Compile Time Error will be thrown.
    private static readonly Assembly ProjectAssembly = typeof(StartUp).Assembly;

    [Test]
    public void Validate_MatchBetween_SecondTeamWin()
    {
        ...
        var methodArgs2 = new object[] { "Liverpool", "SeniorManager", "Jurgen Klopp" };
        ...
        var expectedResult = "Team Manchester City wins the match against Liverpool.";
