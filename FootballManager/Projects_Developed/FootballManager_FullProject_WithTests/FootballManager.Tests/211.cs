...
public class Tests_211
{
    // MUST exist within project, otherwise a Compile Time Error will be thrown.
    private static readonly Assembly ProjectAssembly = typeof(StartUp).Assembly;

    [Test]
    public void Validate_MatchBetween_FirstTeamWing()
    {
        ...
        var methodArgs4 = new object[] { "Manchester City", "SeniorManager", "Pep Guardiola" };
        ...
        var expectedResult = "Team Liverpool wins the match against Manchester City.";
